...
class HomePageState extends State<HomePage> {
  ...
  Future<void> stopSearch() async {
    bool? stopDeviceSearch = await _mobileSmartWatch.stopSearchingDevices();
   ...
   // bool status = await checkAllPermissions();
    ...
    if (initResult !=null) {
      if (initResult.toString() == SmartWatchConstants.BLE_NOT_SUPPORTED) {
        Global.showAlertDialog(context, "Bluetooth 4.0","The Bluetooth version of your handeset is lower than the expectation. Your handset bluetooth doesn't support for the Bluetoothv4.0");
      }else if (initResult.toString() == SmartWatchConstants.SC_CANCELED) {
        Global.showAlertDialog(context, "Bluetooth","Please enable the Bluetooth connectivity to search for devices.");
